...
//   Arenadata: https://arenadata.tech/favicon.ico?favicon.2x2_n5-sqnn90.ico
//   Aston: https://storage.yandexcloud.net/prod.astonsite.s3backet/aston-redisign/common/favicon/AstonFavicon.svg
//   Baum: https://baum.ru/wp-content/uploads/2024/01/favicon.svg
//   Bell Integrator: https://bellintegrator.ru/themes/bell-bootstrap/bellbootstrap/favicon.ico
//   BINOM: https://binom.systems/binom_favicon.svg
...
//   iFellow: https://ifellowgroup.ru/local/templates/main/favicon/apple-touch-icon.png
//   Inline Group: https://inlinegroup.ru/favicon.ico
//   iSpring: https://www.ispring.ru/ispring_content/content/images/favicon/icons/android-icon-512x512.png
//   IT_One: https://www.it-one.ru/bitrix/templates/2200/assets/favicon.ico
//   ITG: https://itglobal.com/apple-touch-icon.png?v=2
...
//   Мария-Ра: https://www.maria-ra.ru/local/templates/main/design/build/img/apple-touch-icon.png
//   МегаФон: https://moscow.megafon.ru/public/favicons/apple-touch-icon-180x180.png
//   МойСклад: https://www.moysklad.ru/favicon.svg
...
//   Ростелеком: https://job.rt.ru/favicon.ico
//   РУСАЛ: https://rusal.ru/local/templates/main/favicon/favicon.ico
//   С-Терра: https://www.s-terra.ru/img/favicon.svg
...
//
// Wildberries / РВБ: белый знак из favicon.svg перекрашен в цвет их же иконки
// для светлой темы (favicon-light-theme.ico, #010A11) — та есть только 32×32.
...
const LOGOS: Record<string, number> = {
  ...
  "arenadata": require('@/assets/logos/arenadata.png'),
  "aston": require('@/assets/logos/aston.png'),
  "baum": require('@/assets/logos/baum.png'),
  "bell integrator": require('@/assets/logos/bell-integrator.png'),
  "binom": require('@/assets/logos/binom.png'),
  ...
  "ifellow": require('@/assets/logos/ifellow.png'),
  "inline group": require('@/assets/logos/inline-group.png'),
  "ispring": require('@/assets/logos/ispring.png'),
  "it_one": require('@/assets/logos/it-one.png'),
  "itg": require('@/assets/logos/itg.png'),
  ...
  "мария-ра": require('@/assets/logos/mariya-ra.png'),
  "мегафон": require('@/assets/logos/megafon.png'),
  "мойсклад": require('@/assets/logos/moysklad.png'),
  ...
  "ростелеком": require('@/assets/logos/rostelekom.png'),
  "русал": require('@/assets/logos/rusal.png'),
  "с-терра": require('@/assets/logos/s-terra.png'),
