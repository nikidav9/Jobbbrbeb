...
// телеграм к чужой учётной записи. Раньше от этого закрывал внешний relay:
// он проверял заголовок сам. Теперь Телеграм ходит сюда напрямую и
// шлёт тот же заголовок нам, если при setWebhook задан secret_token.
//
// Послабление на время переезда. Старый внешний relay проверяет заголовок,
// но дальше не передаёт: для него мы — доверенный адрес. Пока
